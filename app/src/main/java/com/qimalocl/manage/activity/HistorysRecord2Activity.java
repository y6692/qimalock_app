...
public class HistorysRecord2Activity extends SwipeBackActivity implements View.OnClickListener {
...
//    private LoadingDialog loadingDialog;
    ...
    private class MyAdapter extends BaseViewAdapter<HistorysRecordBean>{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (null == convertView) {
                convertView = inflater.inflate(R.layout.item_history_record2, null);
            }
                        ...
                        if (checkPermission != PackageManager.PERMISSION_GRANTED) {
                            if (shouldShowRequestPermissionRationale(Manifest.permission.CALL_PHONE)) {
                                ...
                                customBuilder.setTitle("温馨提示").setMessage("您需要在设置里打开拨打电话权限！")
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        dialog.cancel();
                                        HistorysRecord2Activity.this.requestPermissions(
