...
@SuppressLint("NewApi")
public class ChangeKeyLockManageActivity extends MPermissionsActivity implements OnConnectionListener, OnDeviceSearchListener {
...
//                }
    ...
    Handler m_myHandler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(Message mes) {
            switch (mes.what) {
                case 0:
                    BaseApplication.getInstance().getIBLE().connect(address, ChangeKeyLockManageActivity.this);
                    break;
                case 1:
                    break;
                case 2:
