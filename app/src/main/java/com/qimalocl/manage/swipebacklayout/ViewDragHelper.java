...
package com.qimalocl.manage.swipebacklayout;
...
public class ViewDragHelper {
    ...
    public static final int EDGE_SIZE = 10; // dp
     ...
     * {@link com.lanjing365.swipebacklayout.ViewDragHelper.Callback#tryCaptureView(View, int)}
     ...
     * {@link com.lanjing365.swipebacklayout.ViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
