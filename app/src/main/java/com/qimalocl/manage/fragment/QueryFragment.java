...
@SuppressLint("NewApi")
public class QueryFragment extends BaseFragment implements View.OnClickListener,LocationSource,
...
//                    customBuilder.create().show();
        ...
        aMap.setOnMapTouchListener(QueryFragment.this);
        setUpLocationStyle();
            ...
            public void run() {
                ...
                aMap.animateCamera(update, 1000, new AMap.CancelableCallback() {
                    ...
                    public void onFinish() {
                        aMap.setOnCameraChangeListener(QueryFragment.this);
                    }
                        ...
                        if (checkPermission != PackageManager.PERMISSION_GRANTED) {
                            if (shouldShowRequestPermissionRationale(Manifest.permission.CAMERA)) {
                                ...
                                customBuilder.setTitle("温馨提示").setMessage("您需要在设置里打开相机权限！")
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        dialog.cancel();
                                        QueryFragment.this.requestPermissions(
